---
title: "NLDAS Radiation Problem"
author: "Luke Winslow"
date: "July 16, 2017"
output: html_document
---

NLDAS (National Land Data Assimilation System) from [nasa](https://ldas.gsfc.nasa.gov/nldas/) is an awesome data product. That being said, with NLDAS, I have struggled with one big thing: Wind speed.
...
fields::image.plot(early-late, legend.lab='delta-Avg Wind speed before/after 2001 (m/s)')
```
